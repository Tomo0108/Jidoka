  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <div className="flex-1 relative overflow-hidden">
        <div 
          className="h-full w-full relative border border-slate-200 rounded-lg m-2 shadow-lg bg-white"
        ...
        >
          ...
          >
            ...
            <Panel position="top-right" className="m-4">
              <Card className="p-2 shadow-lg border-slate-200 bg-white/95 backdrop-blur-sm">
            ...
            <Panel position="bottom-right" className="m-4">
              <Card className="p-3 shadow-lg border-slate-200 bg-white/95 backdrop-blur-sm">
            ...
            {/* 条件付きコンポーネント */}
            <Controls 
              className="!bg-white/95 !border-slate-200 !shadow-lg"
              showZoom={false}
              showFitView={false}
