...
const CustomNode: React.FC<NodeProps<CustomNodeData>> = ({ data, selected }) => {
  ...
  const getHandleColor = () => {
    switch (shape) {
      ...
      case 'rectangle':
        return "!bg-[#3498DB] !border-[#3498DB]";
      case 'diamond':
        return "!bg-[#E67E22] !border-[#E67E22]";
      case 'parallelogram':
        return "!bg-[#9B59B6] !border-[#9B59B6]";
      case 'predefinedProcess':
        return "!bg-[#3498DB] !border-[#3498DB]";
      case 'document':
        return "!bg-[#F1C40F] !border-[#F1C40F]";
      default:
        return "!bg-[#3498DB] !border-[#3498DB]";
    }
  };
  ...
  return (
    <div className={cn(
      getShapeClasses(), 
      selected && "ring-2 ring-[#3498DB] ring-offset-2 ring-offset-white dark:ring-offset-[#2C3E50] scale-105",
