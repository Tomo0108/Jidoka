  ...
  return (
    <div className="flex flex-col h-full bg-muted/30">
      ...
      <div className="flex-1 relative overflow-hidden">
        <div 
          className="h-full w-full relative border-2 border-accent/30 rounded-lg m-2 shadow-xl bg-background"
        ...
        >
          ...
          >
            ...
            <Panel position="top-right" className="m-4">
              <Card className="p-2 shadow-xl border-accent/30 bg-background/95 backdrop-blur-md">
            ...
            <Panel position="bottom-right" className="m-4">
              <Card className="p-3 shadow-xl border-accent/30 bg-background/95 backdrop-blur-md">
            ...
            {/* 条件付きコンポーネント */}
            <Controls 
              className="!bg-background/95 !border-accent/30 !shadow-xl !backdrop-blur-md"
              showZoom={false}
              showFitView={false}
