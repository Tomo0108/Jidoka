...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-slate-50 dark:bg-[#2C3E50] border-r border-slate-200 dark:border-slate-600 flex flex-col shadow-lg">
      {/* ヘッダー */}
              <div className="p-4 border-b border-slate-200 dark:border-slate-600 bg-white/80 dark:bg-[#2C3E50]/80 backdrop-blur-sm">
      ...
      {/* フッター */}
      <div className="p-4 border-t border-slate-200 dark:border-slate-600 bg-white/80 dark:bg-[#2C3E50]/80 backdrop-blur-sm">
