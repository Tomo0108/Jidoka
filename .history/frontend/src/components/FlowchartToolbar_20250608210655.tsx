...
export function FlowchartToolbar() {
  ...
  return (
    <Card className="m-2 shadow-lg border-slate-200 bg-white/95 backdrop-blur-sm">
      <div className="flowchart-toolbar flex items-center justify-between p-3 text-slate-700">
        {/* 左側: メイン操作 */}
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:block">
              <h3 className="font-semibold text-sm text-slate-800">フローチャート</h3>
